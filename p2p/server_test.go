...
func (c *testTransport) doProtoHandshake(our *protoHandshake, temporary bool) (*protoHandshake, error) {
...
func (c *setupTransport) doProtoHandshake(our *protoHandshake, temporary bool) (*protoHandshake, error) {
